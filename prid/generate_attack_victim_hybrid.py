...
with torch.no_grad():
    ...
    for count_person in range(150):
        ...
        ds_train = prid2011_single_noaug(
        ...
        train_split = int(10*args.train_ratio)
        semi_split = 10-train_split
...
save_input_file = os.path.join(args.save_path, 'victim_input.csv')
save_label_file = os.path.join(args.save_path, 'victim_labels.csv')
